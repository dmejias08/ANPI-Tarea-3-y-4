% Esta función realiza la integración por el método de Simpson compuesto de manera iterativa,
...
%
% Uso: [I] = simpson_compuesto_iterativo(f, a, b, tol, iterMax)
%
% Argumentos:
...
%
% Esta función utiliza la función `simpson_compuesto` para calcular la aproximación de la integral
% mediante el método de Simpson compuesto con un número determinado de subintervalos.

function [I] = simpson_compuesto_iterativo(f, a, b, tol, iterMax)

  sk = 0;
  sk_1 = 0;

  for k=2:iterMax
    sk_1 = simpson_compuesto(f, a, b, k);
